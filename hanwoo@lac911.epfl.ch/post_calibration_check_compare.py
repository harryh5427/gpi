...
plt.xlabel('HV_prog_NEW_calib (V)')
plt.ylabel('HV_meas_NEW_calib (V)')
plt.xlim(2.8,5.)
...
plt.xlabel('HV_prog_OLD_calib (V)')
plt.ylabel('HV_meas_OLD_calib (V)')
plt.xlim(2.8,5.)
...
plt.figure(181)
line_181_new,=plt.plot(chan_new,apprx_hvmeas_new_when_hvmeas_380,".-")
line_181_old,=plt.plot(chan_old,apprx_hvmeas_old_when_hvmeas_380,".-")
plt.xlabel('Channel number (arbitrary)')
plt.ylabel('HV_meas when HV_meas~380V')
plt.legend([line_181_new,line_181_old],['New_calib','Old_calib'])

plt.figure(18)
line_18_new,=plt.plot(chan_new,gain_arr_new_when_hvmeas_380,".-")
line_18_old,=plt.plot(chan_old,gain_arr_old_when_hvmeas_380,".-")
plt.xlabel('Channel number (arbitrary)')
plt.ylabel('Gain when HV_meas~380V')
plt.legend([line_18_new,line_18_old],['New_calib','Old_calib'])
"""
plt.figure(19)
...
line_20_old,=plt.plot(chan_old,mean_sb_arr_old_when_hvmeas_380,".-")
plt.xlabel('Channel number (arbitrary)')
plt.ylabel('Mean sig_minus_back (V) when HV_meas~380V')
plt.legend([line_20_new,line_20_old],['New_calib','Old_calib'])
"""
plt.figure(182)
line_182_new,=plt.plot(chan_new,apprx_hvmeas_new_when_hvmeas_380,".-")
line_182_old,=plt.plot(chan_old,apprx_hvmeas_old_when_hvmeas_380,".-")
plt.xlabel('Channel number (arbitrary)')
plt.ylabel('HV_meas when HV_meas~380V')
plt.legend([line_182_new,line_182_old],['New_calib','Old_calib'])

plt.figure(183)
line_183_new,=plt.plot(chan_new,gain_arr_new_when_hvmeas_380,".-")
line_183_old,=plt.plot(chan_old,gain_arr_old_when_hvmeas_380,".-")
plt.xlabel('Channel number (arbitrary)')
plt.ylabel('Gain when HV_meas~380V')
plt.legend([line_183_new,line_183_old],['New_calib','Old_calib'])
"""
"""
plt.figure(184)
line_184_new,=plt.plot(chan_new,mean_sb_arr_new_when_hvmeas_380,".-")
line_184_old,=plt.plot(chan_old,mean_sb_arr_old_when_hvmeas_380,".-")
plt.xlabel('Channel number (arbitrary)')
plt.ylabel('Mean sig_minus_back (V) when HV_meas~380V')
plt.legend([line_184_new,line_184_old],['New_calib','Old_calib'])
"""
plt.figure(21)
...
plt.legend([line_21_new,line_21_old],['New_calib','Old_calib'])
...
plt.legend([line_22_new,line_22_old],['New_calib','Old_calib'])
...
plt.legend([line_23_new,line_23_old],['New_calib','Old_calib'])
...
plt.legend([line_24_new,line_24_old],['New_calib','Old_calib'])
...
plt.legend([line_25_new,line_25_old],['New_calib','Old_calib'])
...
plt.legend([line_26_new,line_26_old],['New_calib','Old_calib'])
...
plt.legend([line_27_new,line_27_old],['New_calib','Old_calib'])
...
plt.legend([line_28_new,line_28_old],['New_calib','Old_calib'])
